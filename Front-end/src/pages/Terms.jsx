      ...
      <p className="last-updated">Last updated:- May 22, 2025</p>
        ...
        <section className="terms-content">
            ...
            <p>
                ...
                and use the Site and to download or print a copy of any portion of the Content to which you have
                properly gained access solely for your personal, non-commercial use. We reserve all rights not
                expressly granted to you in and to the Site, the Content and the Marks.
            </p>

            <h2 className="section-heading">USER REPRESENTATIONS</h2>
            ...
            <ol className="terms-list">
                <li>Systematically retrieve data or other content from the Site to create or compile, directly or indirectly, a collection, 
                ...
                <li>
                    Upload or transmit any sexual or pornography videos, contents, images, child abuse content, religion abuse content & anything not 
                    legally permitted in social media.
                </li>
                <li>
                    ...
                    system, including without limitation, any spider, robot, cheat utility, scraper, or offline reader that accesses the Site, or using 
            ...
            <h2 className="section-heading">USER GENERATED CONTRIBUTION</h2>
            <p>
            ...
            <p>
                Contributions may be viewable by other users of the Site and through third-party websites. As such, any Contributions you transmit may be 
            ...
            <ol className="terms-list">
                ...
                <li>
                    ...
                    the Site, and other users of the Site to use your Contributions in any manner contemplated by the Site and these Terms and Conditions.
                </li>
                <li>
                ...
                <li>
                    Your Contributions do not violate any federal or state law concerning child pornography, or otherwise intended to protect the 
            ...
            <h2 className="section-heading">CONTRIBUTION LICENSE</h2>
            <p>
                By posting your Contributions to any part of the Site or making Contributions accessible to the Site by linking your account from 
                the Site to any of your social networking accounts, you automatically grant, and you represent and warrant that you have the right 
                to grant, to us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide 
                right, and license to host, use, copy, reproduce, disclose, sell, resell, publish, broadcast, retitle, archive, store, cache, 
